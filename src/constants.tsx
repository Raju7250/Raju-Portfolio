...
export const experiences = [
    ...
    },
    {
        ...
        'logo': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR1AEW7A_uqJpmjnEAs8OsaMNG1YuoxqLpEWA&s',
        'points': [
            'Gained experience with Git version control contributing to the development and maintenance of code repositories.',
            'Worked with Agile methodologies, participating in daily stand-ups and sprint planning sessions to ensure timely delivery of features and improvements.',
            'Implemented user and role management features, including secure authentication, profile updates, and role-based access control with permissions.',
            'Developed and maintained RESTful APIs for seamless communication between frontend and backend systems, ensuring efficient data retrieval and manipulation.',
            'Designed a call log and attachment tracking system, improving reporting accuracy by 50% and enabling better data-driven decision-making within the customer service application.'
        ],
